export const buttonAddonsHeadingData = [
  {
    text: "Multiple add-ons are supported and can be mixed with buttons input versions.",
  },
];
export const customFormsHeadingData = [
  {
    text: "Input groups include support for",
    code: "custom selects and custom file inputs",
  },
  {
    text: ". Browser home versions of these are not supported.",
  },
];

export const CustomFileInputHeadingData = [
  {
...
export const buttonsWithDropdownsHeadingData = [
  {
    text: "Use the",
    code: ".input-group ",
  },
...
export const checkBoxesAndRadiosHeadingData = [
  {
...
export const segmentedButtonsHeadingData = [
  {
...
export const sizingHeadingData = [
  {
...
export const multipleInputsHeadingData = [
  {
    text: "While multiple",
    code: `<input>`,
  },
...
export const basicInputGroupsHeadingData = [
  {
...
export const VarationOfAddonsHeadingData = [
  {
    text: "Place one add-on or button on either side of an input. You may also place one on both sides of an input. Remember to place",
    code: `<label>`,
  },
...
export const inputMasksHeadingData = [
  {
    text: "Input mask used in form-validations,forms,card-details,and etc.",
  },
];

export const variationRadioHeadingData = [
  {
    text: "Use the",
    code: "radio ",
  },
...
export const variationCheckBoxHeadingData = [
  {
...
export const defaultStyleHeadingData = [
  {
    text: "This option is show by home you don't need to add any extra class.",
  },
];
...
export const activitiesNameData = [
  ...
  { className: "danger", name: "Playing video games" },
...
export const firstButtonsWithDropDowns = [
  { name: "Ecommerce" },
  { name: "Email" },
  { name: "Users" },
  { divider: true },
...
export const secondButtonsWithDropDowns = [
  { name: "Starter kit" },
  { name: "Gallery" },
  { name: "Blog" },
  { divider: true },
...
export const thirdButtonsWithDropDowns = [
  { name: "Widgets" },
  { name: "Project" },
  { name: "Contacts" },
  { divider: true },
...
export const fourthButtonsWithDropDowns = [
  { name: "To-Do" },
  { name: "FAQ" },
  { name: "Knowledgebase" },
  { divider: true },
...
export const firstSegmentedButtonsDropDowns = [
  { name: "Learning" },
  { name: "Editors" },
  { name: "Users" },
  { divider: true },
...
export const secondSegmentedButtonsDropDowns = [
  { name: "Search Result" },
  { name: "Tasks" },
  { name: "Projects" },
  { divider: true },
...
export const withoutBordersStyleHeadingData = [
  {
    text: "By adding",
    code: ".plain-style ",
  },
...
export const solidBordersStyleForm = [
  {
    text: "Use the",
    code: ".border-style",
  },
...
export const offerStyleBorderHeaderData = [
  { text: "Use the", code: ".offer-style " },
  { text: "class to", code: " .mega-inline" },
  { text: "you can archive this style." },
];

export const inlineStyleHeaderData = [
...
export const verticalStyleHeaderData = [
  {
...
export const horizontalStyleHeaderData = [
  {
...
export const tooltipFormValidationDetail = [
  {
...
export const browserDefaultsData = [
  {
...
export const validationFormHeadingData = [
  {
...
export const floatingFormHeaderData = [
  {
    text: "Use the",
    code: `.form-floating`,
  },
...
export const basicFormHeaderData = [
  {
    text: "Use the",
    code: `.form-label `,
  },
...
export const formControlSizingHeaderData = [
  {
...
export const edgesInputStyleHeaderData = [
  {
    text: `Use the`,
    code: `.btn-pill `,
  },
...
export const raiseInputStyleHeaderData = [
  {
    text: `Use the`,
    code: `input-air-*`,
  },
...
export const basicHTMLInputControlHeaderData = [
  {
...
export const basicFloatingInputControlHeaderData = [
  {
    text: `Give textual form controls like`,
    code: `<input>`,
  },
...
export const selectSizingHeaderData = [
  {
    code: ".form-select",
  },
  {
...
export const fileInputHeaderData = [
  {
    code: `<input>`,
...
export const flatInputStyleHeaderData = [
  {
    code: `.btn-square `,
    text: `Use the`,
  },
...
export const defaultCheckBoxHeaderData = [
  {
    code: `.form-check-input  `,
    text: `Use the`,
  },
...
export const customCheckBoxHeaderData = [
  {
    code: `.form-check-input  `,
    text: `Use the`,
  },
...
export const animatedButtonsHeaderData = [
  {
    code: `.radio_animated `,
    text: `Use the`,
  },
...
export const defaultRadioHeaderData = [
  {
    code: `.form-check-input  `,
    text: `Use the`,
  },
...
export const imagesWithCheckBoxHeaderData = [
  {
    code: `.form-check-input  `,
    text: `Use the`,
  },
...
export const customRadioBoxHeaderData = [
  {
    code: `.form-check-input  `,
    text: `Use the`,
  },
...
export const imagesWithRadioBoxHeaderData = [
  {
    code: `.form-check-input  `,
    text: `Use the`,
  },
...
export const defaultSwitchesHeaderData = [
  {
    code: `.form-switch`,
    text: `Use the`,
  },
...
export const inlineInputTypesHeaderData = [
  {
...
export const basicRadioAndCheckBoxHeaderData = [
  {
    code: `.form-check-inline `,
    text: `Use the`,
  },
...
export const radioToggleButtonsHeaderData = [
  {
...
export const outLinedCheckBoxStylesHeaderData = [
  {
...
export const inlineCheckboxData = [
  { tittle: "I", defaultChecked: true },
  { tittle: "II" },
  { tittle: "III (disabled)", disabled: true },
];

export const inlineRadioBoxData = [
  { tittle: "1", defaultChecked: true },
  { tittle: "2" },
  { tittle: "3(disabled)", disabled: true },
];

export const inlineSwitchesData = [
  { defaultChecked: true },
...
export const solidBorderStyleInlineFormData = [
  {
    detail:
      "We provide end to end digital solutions, right from designing your website/application development: Domain, Web Hosting, Email Hosting Registration.",
    imagePath: "blog/img.png",
  },
  {
    detail:
      "When someone visits your homepage, your design should inspire them to stay. Therefore, your value proposition should be established on the homepage for visitors.",
    imagePath: "blog/blog.jpg",
  },
];
