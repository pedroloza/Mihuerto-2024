...
import { DefaultButton, Href } from "utils/Constant";

export const uiComponentTableData = [
  {
    tittle: "Button",
    tableColData: <Button color="primary">{DefaultButton}</Button>,
    details: [
      {
  ...
  },
  {
    ...
    tableColData: (
      <UncontrolledDropdown>
        <DropdownToggle color="primary" className="btn-dropdown" caret>
          Primary
        </DropdownToggle>
        <DropdownMenu>
...
export const progressTableData = [
  {
    ...
    tableColData: <Progress value={75} color="primary" />,
    details: [
      {
  ...
  },
  {
    ...
    tableColData: <Progress striped value={75} color="primary" />,
    details: [
      {
  ...
  },
  {
    ...
    tableColData: (
      <Progress className="lg-progress-bar" value={75} color="primary" />
    ),
    details: [
      {
...
export const radioBoxTableData = [
  {
    ...
    tableColData: (
      <>
        ...
        <label htmlFor="radio" className="ms-2">
          Default radio
        </label>
      </>
    ),
  ...
  },
  {
    ...
    tableColData: (
      <div className="radio radio-primary">
        <Input id="radio12" type="radio" name="radio12" disabled />
        <Label htmlFor="radio12">Option 1</Label>
      </div>
    ),
    details: [
      {
...
export const badgesTableData = [
  {
    ...
    details: [
      ...
      { text: "  class within element to create home pill." },
    ],
  },
  {
...
export const toolTipTriggersData = [
  ...
  {
    tittle: "Link",
    tableColData: <a className="btn btn-primary">Link</a>,
    details: [
      {
        text: "Use the",
        code: "label-square",
