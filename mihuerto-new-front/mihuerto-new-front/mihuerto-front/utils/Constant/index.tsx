...
export const CustomScrolltext: string =
  "There are various justifications for customizing a scrollbar. For instance, the home scrollbar can cause an app's user interface to look inconsistent across various operating systems. In this case, having a single style is helpful.";
...
export const Collapes2Text: string =
  "This is the first item's accordion body. It is shown by home, until the collapse plugin adds the appropriate classes that we use to style each element.These classes control the overall appearance,  well as the showing and hiding via CSS transitions.You can modify any of this with custom CSS or overriding our home variables.";
...
export const CollapesText: string =
  "Some placeholder content for the collapse component. This panel is hidden by home but revealed when the user activates the relevant trigger.";
...
//Incio de sesión
export const SignInAccount: string = "Bienvenido de nuevo";
export const EnterEmailPasswordLogin: string =
  "Ingrese su usuario & contraseña para iniciar";
export const EmailAddress: string = "Usuario";
export const Password: string = "Contraseña";
export const RememberPassword: string = "Recordar contraseña";
export const SignIn: string = "Iniciar Sesión";
export const Lastname: string = "Apellido";

//Users
export const Users: string = "Usuarios";
export const AddNewUser: string = "Añadir usuario";

export const FirstName: string = "Nombre";
export const LastName: string = "Apellido";
export const IdCard: string = "Cédula";
export const BirthDate = "Fecha de Nacimiento";
export const Emailaddress: string = "Correo";
export const Position: string = "Posición";
export const Parish: string = "Parroquia";
export const Address: string = "Dirección";
export const Phone = "Teléfono";
export const Status = "Estado";

export const SubmitForm: string = "Enviar";

//Role
export const Role = "Roles";
export const AddNewRole: string = "Añadir rol";
